...
class Jobs extends Component {
  ...
  renderJobsLists = () => {
    const {jobsLists} = this.state
    const renderJobsLists = jobsLists.length > 0
  ...
  renderFailureView = () => (
    <div className="jobserror-view-container">
      <img
      ...
      <button className="jobserror-btn" type="button">
        Retry
      </button>
    </div>
  )
      ...
      <>
        ...
        <div className="jobs-container">
          <div className="jobs-content">
            <div className="searchinput-jobslist-container">
